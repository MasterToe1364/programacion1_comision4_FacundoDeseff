...
import match
radio_str = input("Ingresar el radio del círculo: ")
...
num1 = int(input("Ingresar el priumer número entero (destino de 0): "))
num2 = int(input("Ingresar el segundo número entero (destino de 0):"))
suma = num1 + num2
resta = num1 - num2
